            ...
            $.getJSON("http://ip-api.com/json", function(data) {
                ...
                $.getJSON(weatherAPI, function(json) {
                  console.log(json);
                    ...
                    if (!stopCheckingArr) { setBackground("url(https://az616578.vo.msecnd.net/files/2016/01/09/635879112155223228-319755513_635861833670816810507191518_6670-perfect-snow-1920x1080-nature-wallpaper.jpg)", "1150px 800px", "no-repeat", snowArr);}
